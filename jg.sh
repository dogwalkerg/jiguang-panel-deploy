...
AURORA_GITHUB="dogwalkerg"
AURORA_YML_URL="https://raw.githubusercontent.com/dogwalkerg/jiguang-panel-deploy/refs/heads/master/docker-compose.yml"
AURORA_DEV_YML_URL="https://${GITHUB_RAW_URL}/${AURORA_GITHUB}/jiguang-panel-deploy/main/docker-compose-dev.yml"
