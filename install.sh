...
AURORA_YML_URL="https://${GITHUB_RAW_URL}/${AURORA_GITHUB}/jiguang_panel-deploy/main/docker-compose.yml"
AURORA_DEV_YML_URL="https://${GITHUB_RAW_URL}/${AURORA_GITHUB}/jiguang_panel-deploy/main/docker-compose-dev.yml"
